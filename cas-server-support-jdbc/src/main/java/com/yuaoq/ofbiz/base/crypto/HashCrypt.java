 ...
 * under the License.
 *******************************************************************************/
package com.yuaoq.ofbiz.base.crypto;

import com.yuaoq.ofbiz.base.util.GeneralRuntimeException;
import com.yuaoq.ofbiz.base.util.StringUtil;
import com.yuaoq.ofbiz.base.util.UtilValidate;
...
public class HashCrypt {
    ...
    private static final Logger Debug = LoggerFactory.getLogger(HashCrypt.class);
    ...
    public static boolean comparePassword(String crypted, String defaultCrypt, String password) {
        try {
            if (crypted.startsWith("{")) {
                ...
                if (hashed.equals(new String(digestChars))) {
                    Debug.warn("Warning: detected oldFunnyHex password prefixed with a hashType; this is not valid", module);
                    return true;
                }
                return false;
    ...
    public static String getDigestHashOldFunnyHexEncode(String str, String hashType) {
        ...
        try {
            ...
            Debug.error(e.getMessage(), "Error while computing hash of type " + hashType, module);
        }
        return str;
    }
}
